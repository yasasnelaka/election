...
public class ElectionController {
    ...
    public String index(HttpSession session, Model model) {
        ...
        List<com.lk.election.models.responseModels.Election> elections = new ArrayList<>();
        for (Election e : electionList) {
            User startedBy = null;
            User endedBy = null;
            com.lk.election.models.responseModels.Election election = new com.lk.election.models.responseModels.Election(e.getId(), e.getName(), e.getYear(), e.getMaxSeats(), e.getStartTime(), startedBy, e.getStartedTime(), e.getEndTime(), endedBy, e.getEndedTime(), e.getVotes(), e.getVotesValid(), e.getVotesInvalid(), e.getElectionStatus());
