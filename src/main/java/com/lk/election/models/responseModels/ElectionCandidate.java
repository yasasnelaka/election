...
import com.lk.election.init.SeatType;
...
public class ElectionCandidate extends Candidate implements Serializable {
    ...
    public ElectionCandidate convertEntityToResponseModel(com.lk.election.dbTier.entities.ElectionCandidate ec, Candidate candidate) {
